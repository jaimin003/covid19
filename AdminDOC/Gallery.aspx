<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDOC/MasterPage.master" AutoEventWireup="true" CodeFile="Gallery.aspx.cs" Inherits="AdminDOC_Default" %>
      ...
      <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            <h5 class="mb-0">Image Profile & Settings</h5>

                            <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    <li class="breadcrumb-item"><a href="Ahome.aspx">Home</a></li>                                    
                        ...
                        <div class="card bg-white rounded shadow overflow-hidden mt-4 border-0">
                            ...
                            <div class="avatar-profile d-flex margin-nagative mt-n5 position-relative ps-3">
                               ...
                               <%-- <img src="" class="rounded-circle shadow-md avatar avatar-medium" alt="">--%>
                                ...
                                <asp:Image ID="imgd" runat="server"   Height="400px" Width="400px" />
                                            ...
                                            <div class="col-md-6">
                                               ...
                                               <center>
                                                   <asp:Button ID="btn_change" class="btn btn-primary" runat="server" 
                                                       Text="Save" onclick="btn_change_Click"  /></center>
