<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDOC/MasterPage.master" AutoEventWireup="true" CodeFile="Hospital_Verified.aspx.cs" Inherits="AdminDOC_Default" %>
...
<div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            <h5 class="mb-0">Lab's Verifed</h5>

                            <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    <li class="breadcrumb-item"><a href="Ahome.aspx">Doctris</a></li>
                                    <li class="breadcrumb-item"><a href="Hospital_list.aspx">Hospitals</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Verified Hospitals</li>
                                </ul>
                            </nav>
                        </div>
