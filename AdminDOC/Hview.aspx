<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDOC/MasterPage.master" AutoEventWireup="true" CodeFile="Hview.aspx.cs" Inherits="AdminDOC_Default" %>
                                        ...
                                        <div class="tab-content mt-2" id="pills-tabContent">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <asp:TextBox ID="txtzone" class="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                                                  <%--  <input name="name" id="Text1" type="text" class="form-control" placeholder="First Name :">--%>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <asp:TextBox ID="txtadd" class="form-control" ReadOnly="true" runat="server"></asp:TextBox>
                                                  <%--  <input name="name" id="Text1" type="text" class="form-control" placeholder="First Name :">--%>
                                                </div>
                                            </div>
