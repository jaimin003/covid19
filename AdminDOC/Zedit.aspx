<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDOC/MasterPage.master" AutoEventWireup="true" CodeFile="Zedit.aspx.cs" Inherits="AdminDOC_Default2" %>
                                            ...
                                            <div class="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="overview-tab">
                                              ...
                                              <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <asp:TextBox ID="txtzname" class="form-control" runat="server"></asp:TextBox>
                                                  <%--  <input name="name" id="Text1" type="text" class="form-control" placeholder="First Name :">--%>
                                                </div>
                                            </div>                                             
