<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDOC/MasterPage.master" AutoEventWireup="true" CodeFile="profile.aspx.cs" Inherits="AdminDOC_Default" %>
                        ...
                        <div class="card bg-white rounded shadow overflow-hidden mt-4 border-0">
                            ...
                            <div class="avatar-profile d-flex margin-nagative mt-n5 position-relative ps-3">
                               ...
                               <%-- <img src="" class="rounded-circle shadow-md avatar avatar-medium" alt="">--%>
                                ...
                                <asp:Image ID="imgd" runat="server"  class="rounded-circle shadow-md avatar avatar-medium" />
                                        ...
                                        <div class="tab-content mt-2" id="pills-tabContent">
                                            ...
                                            <div class="col-md-6">
                                              ...
                                              <div class="col-md-6">
                                               ...
                                               <center><asp:Button ID="btn_change" class="btn btn-primary" runat="server" 
