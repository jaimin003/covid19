<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital_DOC/MasterLab.master" AutoEventWireup="true" CodeFile="Add_Doc.aspx.cs" Inherits="Hospital_DOC_Default" %>
									...
									<div class="row gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
												<label for="fullName">Select Branch</label>
												<%--<input type="text" class="form-control" id="fullName" placeholder="Enter Doctor Name">--%>
                                                <asp:DropDownList ID="ddlbranch" runat="server" 
                                                    DataSourceID="SqlDataSource1" DataTextField="city" DataValueField="city" class="form-control">
                                                </asp:DropDownList>
											    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                                    SelectCommand="SELECT [city] FROM [Hospital_mstr] WHERE ([name] = @name)">
                                                    <SelectParameters>
                                                        <asp:SessionParameter Name="name" SessionField="Hname" Type="String" />
                                                    </SelectParameters>
                                                </asp:SqlDataSource>
											</div>
										</div>
										...
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                                    ErrorMessage="Plzz Enter Doctor Specification*" ControlToValidate="txtspec" 
                                                    ForeColor="Red"></asp:RequiredFieldValidator>
											</div>
										</div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                                    ErrorMessage="Plzz Enter Contact Number*" ControlToValidate="txtphno"></asp:RequiredFieldValidator>
											</div>
										</div>
									   ...
									   <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                                    ErrorMessage="Plzz Enter Your Fees*" ControlToValidate="txtfees"></asp:RequiredFieldValidator>
											</div>
										</div>
