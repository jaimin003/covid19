...
using paytm;
public partial class PaymentA_PaytmA : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cn.Open();
        qry = "select * from Apaid where pname='" + pname1 + "' and email='" +email1+ "'";
        ...
        if (dr.HasRows)
        {
            ...
            parameters.Add("CALLBACK_URL", "http://localhost:1235/PHC_revised/PaymentA/Suc.aspx"); //This parameter is not mandatory. Use this to pass the callback url dynamically.
