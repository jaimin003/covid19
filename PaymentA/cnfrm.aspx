<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cnfrm.aspx.cs" Inherits="PaymentA_cnfrm" %>
        ...
        <div class="col-md-9 col-lg-7 col-xl-6 mx-auto">
          <div class="bg-white shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4"> 
            ...
            <div class="form-row align-items-center">
              <p class="col-sm-4 text-5 font-weight-400  text-sm-right mb-0 mb-sm-3">Patient Name:</p>
              <asp:Label ID="lblpname" class="col-sm-8  text-dark mb-0 mb-sm-3 font-weight-200 text-4" runat="server" Text="label"></asp:Label>
             <%-- <p class="col-sm-8 text-3">Smith Rhodes</p>--%>
             
            </div>
            <div class="form-row align-items-center">
              <p class="col-sm-4 text-5 font-weight-400 text-sm-right mb-0 mb-sm-3">Doctor Name:</p>
               <asp:Label ID="lbldname" class="col-sm-8  text-dark mb-0 mb-sm-3 font-weight-200 text-4" runat="server" Text="label"></asp:Label>
              
            </div>            
            <div class="form-row align-items-center">
              <p class="col-sm-4 text-4 font-weight-400 text-sm-right mb-0 mb-sm-3">Doctor Speciality:</p>
               <asp:Label ID="lbldesg" class="col-sm-8  text-dark mb-0 mb-sm-3 font-weight-200 text-4" runat="server" Text="label"></asp:Label>
            </div>
            <div class="form-row align-items-center">
            ...
            <div class="form-row align-items-center">
              <p class="col-sm-4 text-5 font-weight-400 text-sm-right mb-0 mb-sm-3">Total Amount:</p>
               <asp:Label ID="lblfees" class="col-sm-8  text-dark mb-0 mb-sm-3 font-weight-200 text-4" runat="server" Text="label"></asp:Label>
            </div>
            <div class="form-row align-items-center">
              <p class="col-sm-4 text-4 font-weight-400 text-sm-right font-weight-500 mb-0 mb-sm-3">Payment Date:</p>
            ...
            <asp:Button ID="btn_Sub" runat="server"   class="btn btn-primary btn-block" 
                Text="Confirm" onclick="btn_Sub_Click1" />
            <br />
            <br />
