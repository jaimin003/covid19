<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CashF.aspx.cs" Inherits="PaymentB_CashF" %>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-prepend"> <span class="input-group-text">Rs</span> </div>
                   <asp:TextBox ID="txtfees" runat="server"  class="form-control" data-bv-field="price" placeholder="Fees" ReadOnly="True"></asp:TextBox>
