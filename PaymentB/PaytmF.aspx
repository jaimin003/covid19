<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaytmF.aspx.cs" Inherits="PaymentB_PaytmF" %>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-prepend"> <span class="input-group-text">Rs</span> </div>
                    <asp:TextBox ID="txtfees"  ReadOnly="True" runat="server" class="form-control" data-bv-field="youSend"></asp:TextBox>
