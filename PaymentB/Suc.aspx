<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Suc.aspx.cs" Inherits="PaymentB_Suc" %>
      ...
      <div class="row">
        <div class="col-md-9 col-lg-7 col-xl-6 mx-auto"> 
          ...
          <div class="bg-white text-center shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
            ...
            <a class="text-3 d-inline-block btn-link mt-4" href="../UserCovid/ViewBbill.aspx"><i class="fas fa-print"></i> Print</a><br />
            <a class="btn-link" href="../UserCovid/Uhome.aspx"><-Go To Home</a> </div>
        </div>
      </div>
    </div>
  </div>
