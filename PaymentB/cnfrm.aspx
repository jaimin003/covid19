<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cnfrm.aspx.cs" Inherits="PaymentB_cnfrm" %>
      ...
      <div class="row">
        <div class="col-md-9 col-lg-7 col-xl-6 mx-auto">
          <div class="bg-white shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4"> 
            ...
            <div class="form-row align-items-center">
              <p class="col-sm-4 text-5 font-weight-400  text-sm-right mb-0 mb-sm-3">Mobile No:</p>
               <asp:Label ID="lblphno" class="col-sm-8  text-dark mb-0 mb-sm-3 font-weight-200 text-4" runat="server" Text="label"></asp:Label>
            </div>                          
            <div class="form-row align-items-center">
              <p class="col-sm-4 text-5 font-weight-400  text-sm-right mb-0 mb-sm-3">No Of Day:</p>
               <asp:Label ID="lbltday" class="col-sm-8  text-dark mb-0 mb-sm-3 font-weight-200 text-4" runat="server" Text="label"></asp:Label>
              
            </div>   
            <div class="form-row align-items-center">
              <p class="col-sm-4 text-5 font-weight-400  text-sm-right mb-0 mb-sm-3">Total Amount:</p>
               <asp:Label ID="lbltamt" class="col-sm-8  text-dark mb-0 mb-sm-3 font-weight-200 text-4" runat="server" Text="label"></asp:Label>
            </div>
            <div class="form-row align-items-center">
