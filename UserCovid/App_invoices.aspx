<%@ Page Title="" Language="C#" MasterPageFile="~/UserCovid/User_Corona.master" AutoEventWireup="true" CodeFile="App_invoices.aspx.cs" Inherits="UserCovid_Default" %>
                        ...
                        <div class="card bg-white border-0 rounded shadow px-4 py-5">
                            <div class="row mb-4">
                                <div class="col-lg-8 col-md-6">
                                    <img src="ashok.jpeg" height="24" alt=""  width="90">
                                    <h6 class="mt-4"></h6>
                                ...
                                <div class="col-lg-4 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    <ul class="list-unstyled">
                                        <li class="d-flex">
                                            <small class="mb-0 text-muted">Hospital Name : </small>
                                            <small class="mb-0 text-dark">&nbsp;&nbsp;<asp:Label ID="lblhname" runat="server" Text="Label"></asp:Label></small>
                                        </li>
                                    ...
                                    <div class="col-lg-4 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                        <ul class="list-unstyled">
                                            <li class="d-flex mt-2">
                                                ...
                                                <small class="mb-0 text-dark">&nbsp;&nbsp;<asp:Label ID="lbldname" runat="server" Text="Label"></asp:Label></small>
                                            </li>
                                            <li class="d-flex mt-2">
                                                <small class="mb-0 text-muted">Speciality : </small>
                                                <small class="mb-0 text-dark">&nbsp;&nbsp;<asp:Label ID="lbldesg" runat="server" Text="Label"></asp:Label></small>
                                            </li>
    
                                            <li class="d-flex mt-2">
                                                <small class="mb-0 text-muted">payment Date : </small>
                                                <small class="mb-0 text-dark">&nbsp;&nbsp;<asp:Label ID="lblpdate" runat="server" Text="Label"></asp:Label></small>
                                            </li>
