<%@ Page Title="" Language="C#" MasterPageFile="~/UserCovid/User_Corona.master" AutoEventWireup="true" CodeFile="Uedit.aspx.cs" Inherits="UserCovid_Default" %>
                            ...
                            <div class="row">
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    ...
                                                    <div class="single-thumb">
                                                        <asp:Image ID="imgd"  runat="server" Height="350px" Width="400px" /></div>
                                                        <br />
                                                    <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label>     <asp:FileUpload ID="FileUpload1" runat="server" />
                                                </div>                                                    
                                               <%-- <div class="swiper-slide">
                                ...
                                <div class="col-md-7  offset-1 col-12">
                                    <div class="post-content">
                                        ...
                                        <asp:TextBox ID="txtname" class="form-control" runat="server"  Font-Size="Large" ></asp:TextBox>
                                       </div>
                                       <br/>
                                       <div class="post-content">
                                        <h4>Your Contact No :</h4>                                                                                
                                        
                                        <asp:TextBox ID="txtcno" class="form-control" runat="server"  Font-Size="Large" ></asp:TextBox>
                                       ...
                                       <div class="post-content">
                                        ...
                                        <asp:TextBox ID="txtage" class="form-control" runat="server"  Font-Size="Large" ></asp:TextBox>
                                                                                                                  
                                       </div>
                                       <br/>                                                        
                                       <div class="post-content">
                                       <strong> <h5>Your Email : </h5></strong>
                                        
                                        <asp:TextBox ID="txtemail" class="form-control" runat="server"  Font-Size="Large" ></asp:TextBox>                                      
                                        <br />                                                                              
                                       </div>
                                       
                        
                        
                                   <%--<asp:Button ID="btn_go" runat="server" Text="Go Back"  class="lab-btn" />--%>
                                            <%--<button type="submit" class="lab-btn"><span>Add To Cart</span></button>--%>
                                       
                                    </div>
                                     <div class="review">
                            
                                <asp:Button ID="btn_upload" runat="server" Text="Upload" class="btn-success col-sm-4" 
                                             onclick="btn_upload_Click"/>
                                  <asp:Button ID="Button1" runat="server" Text="Save Changes" 
                                             class="lab-btn text-white col-sm-4 offset-2" onclick="Button1_Click"/>
