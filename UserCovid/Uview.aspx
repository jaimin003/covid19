<%@ Page Title="" Language="C#" MasterPageFile="~/UserCovid/User_Corona.master" AutoEventWireup="true" CodeFile="Uview.aspx.cs" Inherits="UserCovid_Default" %>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="product-thumb">
                                       ...
                                       <ItemTemplate>
                                                    ...
                                                    <div class="single-thumb"><img src="../User_img/<%#Eval("img")%>" alt="user image"/></div>
                                                </div>
                                               <%-- <div class="swiper-slide">
                                ...
                                <div class="col-md-7  offset-1 col-12">
                                    <div class="post-content">
                                       ...
                                       <br/>
                                       <div class="post-content">
                                        <h4>Your Contact No : <%#Eval("cno") %></h4>                                                                                
                                       </div>
                                       <br />                                                                                                   
                                       <div class="post-content">
                                        <h4>Your Age : <%#Eval("age") %></h4>                                                                               
                                       </div>
                                       <br/>                                                        
                                       <div class="post-content">
...
<%--                         <div class="review">
                            <ul class="review-nav lab-ul">
                                ...
                                <li class="rev active" data-target="review-content-show">Reviews 4</li>
                                    ...
                                    <asp:Button ID="btn_go" runat="server" Text="Go Back"  class="lab-btn text-white" onclick="btn_go_Click"/>
                                            <%--<button type="submit" class="lab-btn"><span>Add To Cart</span></button>--%>
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                        ...
                                                        SelectCommand="SELECT * FROM [Uregister_mstr] WHERE (([name] = @name) AND ([email] = @email))">
                                                        <SelectParameters>
                                                            <asp:SessionParameter Name="name" SessionField="uname" Type="String" />
                                                            <asp:SessionParameter Name="email" SessionField="umail" Type="String" />
                                                        </SelectParameters>
                                                    </asp:SqlDataSource>
                                                     </form>
