<%@ Page Title="" Language="C#" MasterPageFile="~/UserCovid/User_Corona.master" AutoEventWireup="true" CodeFile="ViewTestIS.aspx.cs" Inherits="UserCovid_Default" %>
...
<form id="form1" runat="server">
        ...
        <section class="bg-half-170 bg-light">
            ...
            <br />
            <br />
                <h2 class="display-4 text-danger text-center">COVID-19 TEST INVOICE</h2>
                <br />
                            ...
                            <div class="pt-4 border-top">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-6">
                                       ...
                                       <div class="col-lg-8 col-md-6">
                                     <h5 class="text-muted fw-bold">Total Amt <span class="badge badge-pill badge-soft-success fw-normal ms-2"></span></h5>
                                        <h6><strong><asp:Label   ID="lblamt" runat="server" Text="Label"></asp:Label></strong></h6>
                                    </div><!--end col-->
    </div>
    </div>
