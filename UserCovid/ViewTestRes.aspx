<%@ Page Title="" Language="C#" MasterPageFile="~/UserCovid/User_Corona.master" AutoEventWireup="true" CodeFile="ViewTestRes.aspx.cs" Inherits="UserCovid_Default" %>
                        ...
                        <div class="card bg-white border-0 rounded shadow px-4 py-5">                      
                            <div class="row mb-4">
                                <div class="col-lg-8 col-md-6">                                
                                    <img src="01.png" align="middle"  alt="">
                                    <h6 class="mt-4"></h6> 
                                    <h7 class="mt-4"></h7> 
