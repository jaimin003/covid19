<%@ Page Title="" Language="C#" MasterPageFile="~/UserCovid/User_Corona.master" AutoEventWireup="true" CodeFile="ViewTestResS.aspx.cs" Inherits="UserCovid_Default" %>
...
<form id="form1" runat="server">
        ...
        <section class="bg-half-170 bg-light">
            ...
            <br />
            <br />
                <h2 class="display-4 text-danger text-center">COVID-19 TEST REPORT</h2>
                <br />
                        ...
                        <div class="card bg-white border-0 rounded shadow px-4 py-5">                      
                            <div class="row mb-4">
                                <div class="col-lg-8 col-md-6">                                
                                    <img src="ashok.jpeg" align="middle"  alt="" width="90">
                                    <h6 class="mt-4"></h6> 
                                    <h7 class="mt-4"></h7> 
                            ...
                            <div class="pt-4 border-top">
                                <div class="row">
                                    <div class="col-lg-8 col-md-6">
                                        <h5 class="text-muted fw-bold">Name of Patient <span class="badge badge-pill badge-soft-success fw-normal ms-2"></span></h5>
                                        <h6><asp:Label ID="lblpname" runat="server" Text="Label"></asp:Label></h6>
                                    </div><!--end col-->
                                    <div class="col-lg-8 col-md-6">
                                        <h5 class="text-muted fw-bold">Result <span class="badge badge-pill badge-soft-success fw-normal ms-2"></span></h5>
                                        <h6><strong><asp:Label  class="text-danger" ID="lblres" runat="server" Text="Label"></asp:Label></strong></h6>
                                    </div><!--end col-->
                                       <div class="col-lg-8 col-md-6">
                                        <h5 class="text-muted fw-bold">Hospital <span class="badge badge-pill badge-soft-success fw-normal ms-2"></span></h5>
                                   ...
                                   <ul>
                                        ...
                                        <li class="d-flex mt-2">
                                            <small class="mb-0 text-muted">Blood Group :   </small>
                                            <small class="mb-0"><a><asp:Label ID="lblbld" runat="server" Text=""></asp:Label></a></small>
                                        </li>
                                        <li class="d-flex mt-2">
                                        <small class="mb-0 text-muted">Date :   </small>
                                            <small class="mb-0 text-muted"><asp:Label ID="lbldate" runat="server" Text=""></asp:Label></small>
