<%@ Page Title="" Language="C#" MasterPageFile="~/UserCovid/User_Corona.master" AutoEventWireup="true" CodeFile="View_certiS.aspx.cs" Inherits="UserCovid_Default" %>
...
<form id="form1" runat="server">
        ...
        <section class="bg-half-170 bg-light">
            <div class="container">
                <h2 class="display-4 text-danger text-center">VACCINE CERTIFICATE</h2>
