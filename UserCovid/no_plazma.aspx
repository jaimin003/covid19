<%@ Page Title="" Language="C#" MasterPageFile="~/UserCovid/User_Corona.master" AutoEventWireup="true" CodeFile="no_plazma.aspx.cs" Inherits="UserCovid_Default" %>
...
<section class="faq-section bg-faq padding-tb">
            ...
            <div class="container">
                <div class="section-header wow fadeInUp" data-wow-delay="0.3s">
                    <h2 class="text-danger display-2">YOU CANNOT DONATE PLAZMA</h2>
