<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaytmF.aspx.cs" Inherits="payment_Default2" %>
...
<%--<h2 class="text-success text-center display-4">SELECT YOUR PAYMENT METHOD</h2><br />--%>
  ...
  <div class="bg-primary">
    <div class="container d-flex justify-content-center">
      <ul class="nav secondary-nav">
        <%--<li class="nav-item"> <a class="nav-link " href="CashF.aspx">CASH</a></li>--%>
        <li class="nav-item"> <a class="nav-link active" href="PaytmF.aspx">PAYTM</a></li>
      </ul>
    </div>
  </div>
  <!-- Secondary menu end --> 
  ...
  <div id="content" class="py-4">
    <div class="container"> 
        ...
        <div class="col-lg-11 mx-auto">
          <div class="row widget-steps">
            <div class="col-4 step active">
              ...
              <a href="PaytmF.aspx" class="step-dot"></a> </div>
      ...
      <h2 class="font-weight-400 text-center mt-3">Online Payment</h2>
        ...
        <div class="col-md-9 col-lg-7 col-xl-6 mx-auto">
          <div class="bg-white shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
            ...
            <form  runat="server" method="post">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-prepend"> <span class="input-group-text">Rs</span> </div>
                    <asp:TextBox ID="txtprice"  ReadOnly="True" runat="server" class="form-control" data-bv-field="youSend"></asp:TextBox>
              ...
              <p class="text-muted text-center"><span class="font-weight-500"></span></p>
            
              <p class="text-4 font-weight-500">Total To Pay<span class="float-right"><asp:Label ID="lblp" runat="server" Text="Label"></asp:Label></span></p>
                          <asp:Button ID="btn_paytm" runat="server"  
                  class="btn btn-primary btn-block" Text="PAYMENT" onclick="btn_paytm_Click" />
