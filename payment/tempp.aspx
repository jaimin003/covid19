<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tempp.aspx.cs" Inherits="payment_PaytmF" %>
  ...
  <div class="bg-primary">
    <div class="container d-flex justify-content-center">
      <ul class="nav secondary-nav">
        ...
        <li class="nav-item"> <a class="nav-link" href="http://demo.harnishdesign.net/html/payyed/request-money.html">Request</a></li>
      </ul>
    </div>
  </div>
  <!-- Secondary menu end --> 
