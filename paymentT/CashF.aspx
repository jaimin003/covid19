<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CashF.aspx.cs" Inherits="paymentT_CashF" %>
        ...
        <div class="col-md-9 col-lg-7 col-xl-6 mx-auto">
          <div class="bg-white shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
            ...
            <form id="Form1" runat="server" method="post">
              ...
              <div class="form-group">
                <label for="recipientGets">Your Amount</label>
                <div class="input-group">
                  <div class="input-group-prepend"> <span class="input-group-text">Rs</span> </div>
                   <asp:TextBox ID="txttamt" runat="server"  class="form-control" data-bv-field="price" placeholder="Price" ReadOnly="True"></asp:TextBox>
                  ...
                  <div class="input-group-append"> <span class="input-group-text p-0">
                    <select id="recipientCurrency" data-style="custom-select bg-transparent border-0" data-container="body" data-live-search="false" class="selectpicker form-control bg-transparent" required="">
                      <optgroup >
         ...
         <%--     <p>Total Fees <span class="float-right">7.21 USD</span></p>--%>
            ...
            <asp:Button ID="Button1"  runat="server" class="btn btn-primary btn-block" 
                  Text="Payment" onclick="Button1_Click" />
