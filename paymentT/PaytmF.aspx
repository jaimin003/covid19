<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaytmF.aspx.cs" Inherits="paymentT_PaytmF" %>
          ...
          <div class="bg-white shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
            ...
            <form id="Form1"  runat="server" method="post">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-prepend"> <span class="input-group-text">Rs</span> </div>
                    <asp:TextBox ID="txttamt"  ReadOnly="True" runat="server" class="form-control" data-bv-field="youSend"></asp:TextBox>
              ...
              <p class="text-4 font-weight-500">Total To Pay<span class="float-right"><asp:Label ID="lblp" runat="server" Text="Label"></asp:Label></span></p>
                  ...
                  class="btn btn-primary btn-block" Text="PAYMENT" 
                  onclick="btn_paytm_Click"  />
