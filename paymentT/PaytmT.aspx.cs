...
using paytm;
public partial class paymentT_PaytmT : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (dr.HasRows)
        {
            ...
            parameters.Add("CALLBACK_URL", "http://localhost:1235/PHC_revised/paymentT/Suc.aspx"); //This parameter is not mandatory. Use this to pass the callback url dynamically.
